...
final class FeedTableViewCell: UITableViewCell {
    ...
    private lazy var contentsLabel : UILabel = {
        ...
        label.text = "이 게시물은 영국에서 시작되어, 글을 본 10일 이내에 100곳에 글을 옮기지 않으면, 별스타그램 세상에서 행복할 수 없을지도 모르는다. 이 게시물의 내용을 무시하고 옮기지않은 김아무개는 그 이후로 좋아요를 받지 못했으며 결국 팔로워도 0이 되었다."
        return label
    }()
